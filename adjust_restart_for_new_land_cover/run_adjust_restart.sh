...
#PBS -l mem=8GB
#PBS -l ncpus=1
#PBS -l storage=gdata/xp65+gdata/p66+gdata/vk83
#PBS -l wd
...
# Add the -s/--stash arguments to scripts 1 and 3 if you want to use a different STASHmaster than that on vk83.
